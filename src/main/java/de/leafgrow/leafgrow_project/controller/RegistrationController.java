...
public class RegistrationController {
  ...
  @PostMapping
  @Operation(summary = "register", description = "Registration required user")
  ...
  @GetMapping("/resent")
  @Operation(summary = "resent", description = "Resenting confirmation to email")
  public ResponseEntity<Response> resendConfirmation(@RequestParam String email) {
    ...
    return ResponseEntity.ok(
        new Response("Registration confirmation has been resent. Please check your mailbox."));
  }

  @GetMapping("/confirm")
  @Operation(summary = "confirm", description = "Confirming user's registration")
  public ResponseEntity<Response> confirmAccount(@RequestParam String code) {
    try {
      ...
      return ResponseEntity.ok(
          new Response("Account is successfully activated. Now you can log in."));
    } catch (Exception e) {
